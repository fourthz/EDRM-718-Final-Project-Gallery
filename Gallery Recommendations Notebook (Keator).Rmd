...
graph should be included in my final report to the client. Note that multiple
analysts are welcome to suggest the same type of graph from their report. 
...
#### Lynsey's Recommendation

I suggest using Figures #5 and #6 from my analyses. Figure #5 clearly displays
the relationship of GPA and job optimism for each discipline and Figure #6 
shows how this level of optimism varies across disciplines. Showing the clients 
these figures will help them to understand not only how academic achievement 
plays a role in post-graduation optimism, but also how this changes across 
discipline.
