...
#### Genee's Recommendation

I suggest using Figure 4 and Figure 7 from my analysis. The first graph clearly 
displays the relationship of GPA and survey results. While the second graph shows 
the display of survey data based off of disciplines. These 
graphs will help the client in understanding how student's acadmeic success and
discpline may impact their perceived optimism about future jobs. 
