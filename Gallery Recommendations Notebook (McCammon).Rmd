...
#### Meka's Recommendation

I suggest using Figure #4 from my analysis. This graph is aesthetically 
pleasing and clearly descibes the results of the research question.
This graph will allow the researcher to report differences between all 
of the disciplines and make conclusive statements about the survey results. 
